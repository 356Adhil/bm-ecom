...
export const sampleProducts = [
  {
    ...
    rating: 4.5,
    isLiked: false,
    specs: ['Bluetooth 5.0', 'Active Noise Cancellation', '30hr Battery', 'Quick Charge'],
    stock: 15,
  },
  {
    id: 2,
    ...
    rating: 4.8,
    isLiked: false,
    specs: ['Heart Rate Monitor', 'GPS', '5ATM Water Resistant', '7-day Battery'],
    stock: 8,
  },
  {
    id: 3,
    ...
    rating: 4.3,
    isLiked: false,
    specs: ['100% Organic Cotton', 'Machine Washable', 'Sustainable', 'Multiple Colors'],
    stock: 50,
  },
  {
    id: 4,
    ...
    rating: 4.6,
    isLiked: false,
    specs: ['Genuine Leather', 'RFID Protection', '6 Card Slots', 'Coin Pocket'],
    stock: 25,
  },
];
